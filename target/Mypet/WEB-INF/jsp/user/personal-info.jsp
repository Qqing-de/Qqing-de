        ...
        <div class="settings-wrapper" id="pad-wrapper">
            ...
            <div class="span3 avatar-box">
                <div class="personal-image">
                    <img src="/static/images/user/${user.pic}" alt="" class="avatar img-circle" id="user_pic_modal_btn" style="height: 200px;width: 200px"/>
                    ...
                    <div class="field-box">
                        ...
                        <div class="ui-select">
                            <select id="edit_state" name="state" value="${user.state}">
                                <option value="1" selected="state">有领养经历</option>
                                <option value="0" selected="state">无领养经历</option>
                            </select>
                        </div>
                    </div>
