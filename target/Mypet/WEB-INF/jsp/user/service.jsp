...
<div class="row" style="position: relative; margin-top: -70px; width: 1000px;">
    <!-- 分页条信息 -->
    <div class="col-md-5" id="page_info_area"></div>
    <div class="col-md-4 myPage" id="page_nav_area" style="margin-bottom: -4px;">
</div>
