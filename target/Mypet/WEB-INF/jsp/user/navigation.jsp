        ...
        <div class='container'>
            <div class='collapse navbar-collapse'>
                <ul>
                    ...
                    <div class="header">
                        ...
                        <div class="logo">
                            <a href="${path}/admin/login">
                                    <img class="logo-img center-block" src="/static/images/home/logo.jpg" width="130px" alt="" />
                                </a>
                    ...
                    <li  class="ndaoh">
                        <a href="${path}/user/teamBlog">志愿活动</a>
                    </li>
                    <li  class="ndaoh">
                        <a href="${path}/user/team">活动报名</a>
                    </li>
                    ...
                    <c:if test="${sessionScope.isLogin}" var="flage" scope="session">
                        <li id="edit_logout">
                            <div class="img"><img src="/static/images/user/${user.getPic()}" alt="" width="60px"
                                                  style="border-radius:20% " value="${user.getId()}"
                                                  id="user_edit_modal_btn"></div>
                        </li>
                        <a id="logout">退出</a>
                    </c:if>
                    <c:if test="${!flage}" var="flage" scope="session">
                        <li id="login_register" style="padding-left: 150px;">
                            <button class="btn-primary btn-lg" data-toggle="modal" data-target="#login" style="padding: 1px 5px;font-size: 15px;background-color: #7d91a8;border-color: #ffff00">登&nbsp录</button>
                        </li>
                    </c:if>
                </ul>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="tab">
                    <div class="modal-body">
                        <%--注册--%>
                        <form class="form-horizontal" id="user_register_form" method="post" action="${path}/user/create"
                              enctype="multipart/form-data">
<%--                            <span id="hit_confirmpwd" style="color: #ff0000;border-radius: 15px;margin-top: -30px;font-size: 17px;padding: 4px;position: absolute;">${uerror}11</span>--%>
                            <div class="form-group">
                                <label for="new_userName" class="col-sm-2 control-label">
                                    名称
                                </label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="new_userName" placeholder="输入名称"
                                           name="userName">
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="new_password" placeholder="创建密码"
                                           name="password">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="new_age" placeholder="输入年龄" name="age">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="new_telephone" placeholder="电话/其它"
                                           name="telephone">
                                </div>
