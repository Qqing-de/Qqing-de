...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            <img class="logo-img center-block" src="/static/images/home/logo.jpg" width="130px" style="margin-left: 2px;margin-top: 2px;" alt="" />
        </div>
        <!-- 导航栏右侧图标部分 -->
        <!-- 导航栏右侧图标部分 -->
