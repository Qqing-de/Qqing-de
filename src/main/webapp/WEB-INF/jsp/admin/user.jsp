...
<html><head>
    ...
    <style>
        ...
        .btn-primary:hover{
            transition: all 0.5s linear;
            background-color: rgb(166, 60, 50);
        }
        .edit_btn{
            transition: all 0.5s linear;
...
<div id="wrapper">
    <!-- 导航栏部分 -->
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;margin-bottom: 8px;border-color: #f8f8f8;">
        <div class="navbar-header">
            <a class="navbar-brand">
                <img class="logo-img center-block" src="/static/images/home/logo.jpg" width="130px" style="margin-top: -13px;    margin-left: -13px;" alt="" />
            </a>
        </div>
        <!-- 导航栏右侧图标部分 -->
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <div class="img" style="position: absolute; margin-left: -80px;margin-top: -50px;"><img src="/static/images/admin/${admin.getPic()}" alt="" width="60px" height="60px" style="border-radius:20% " value="${admin.getId()}" id="user_edit_modal_btn"></div>
    ...
    function build_users_table(result){
        ...
        $.each(users,function(index,user){
            ...
            var editBtn = $("<button></button>").addClass("btn btn-primary btn-sm edit_btn")
                .append($("<span></span>").addClass("")).append("修改");
