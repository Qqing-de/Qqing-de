...
<head>
    ...
    <style type="text/css">
        ...
        .btn-primaryq{
            ...
            background-color: rgba(255, 103, 89) ;
            border-color: rgba(255, 103, 89) ;
        }
        .btn-primaryq:hover{
            color: #fffc68;
            transition: all 0.5s linear;
            background-color: rgb(224, 96, 68);
        }

        .jieshao{
            transition: all 0.5s linear;
            border-radius: 10px;
            background-color: rgb(148, 192, 191);
        }
        .jieshao:hover{
            transition: all 0.5s linear;
            border-radius: 20px;
            background-color: rgba(55, 255, 223, 0.96);
        }
...
<div class="myDiv">
    <div style="height: 500px;">
        <div class="navy" style="padding-left: 650px; font-family: Math;">
        <span style="--i:1;">领</span>
        <span style="--i:2;">养</span>
        <span style="--i:3;">我</span>
        <span style="--i:4;">吧</span>
        <span style="--i:5;">！</span>
        </div>
        <center>
            ...
            <div class="name" style="margin-top: -350px;position: absolute;margin-left: 80px;font-family: 幼圆;color: #ff6759;font-weight: bold;">
                <span>昵称: ${pet.petName}</span>
            </div>
        </center>
        <div class="animal" style="margin-top: -350px;position: absolute;margin-left: 1050px;">
            <div class="group">
                <div class="animalX1">
                   <span style="color: #ff6759;font-family: 幼圆">编号</span><br>
                    <p style="bottom: -20px;">${pet.id}</p>
                </div>
                <div class="animalX2">
                    <span style="color: #ff6759;font-family: 幼圆">生日</span><br>
                    <p style="bottom: -20px;margin-left: 80px;">
            ...
            <div class="group">
                <div class="animalX3">
                   <span style="color: #ff6759;font-family: 幼圆">品种</span><br>
                    <p style="bottom: -20px;margin-left: 140px;">${pet.petType}</p>
                </div>
                <div class="animalX4">
                    <span style="color: #ff6759;font-family: 幼圆">性别</span><br>
                    <p style="bottom: -20px;margin-left: 140px;">${pet.sex}</p>
                </div>
            </div>
        </div>
        <div class="animal_me" style="margin-left: 80px;margin-top: -80px;">
            <div class="animal_me1" style="margin-left: inherit;margin-bottom: -16px;font-size: 18px;font-family: 幼圆;font-weight: 700;">
                小动物介绍
            </div>
            <div class="animal_me2 jieshao" style="padding: 10px;"><p>我的名字是${pet.petName}。我的特点是:${pet.remark}。</p></div>
        </div>
        <div class="my_btn" style="margin-top: 160px;margin-left: 1160px;">
            <button class="btn  btn-lg btn-primaryq" id="pet_adopt_modal_btn">领养ta</button>
            <button class="btn  btn-lg btn-primaryq" id="tianchuan_btn"
                    style="float: right;position: relative;left: 150px;bottom: 45px">返回首页
            </button>
        </div>
    </div>
